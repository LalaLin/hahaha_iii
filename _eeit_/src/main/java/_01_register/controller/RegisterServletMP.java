...
import _01_register.model.MemberDaoImpl_Jdbc;
/*
 * 本程式在後端執行，它會(1)讀取使用者由前端網頁輸入資料，(2)進行必要的資料轉換，
 * (3)檢查使用者輸入資料，(4)進行Business Logic運算，(5)依照Business Logic
 * 運算結果來送回適當的畫面給前端的使用者。
 * 
 */
//
